...
import { LoadingSpinner, EmptyState, Badge } from '../styles/SharedStyles';
      ...
      <ContentSection>
        <MainCard theme={theme}>
          ...
          <RecommendationBox>
            ...
            <p>
              With a sustainability score of <strong>{destination.sustainabilityScore}/100</strong> and excellent
              public transportation infrastructure ({destination.publicTransportScore}/100), this destination is
              perfect for eco-conscious travelers. The low carbon footprint ({destination.co2PerTrip} kg CO₂) and
              {destination.crowdIndex < 70 ? ' peaceful atmosphere' : ' vibrant energy'} make it an ideal choice
