          ...
          <CardGrid>
            {filteredDestinations.map(destination => (
              <DestinationCard key={destination.id} theme={theme}>
                <ImageSlideshow>
                  <Slide src={`https://picsum.photos/400/300?random=${destination.id}1`} active={slideIndex === 0} />
                  <Slide src={`https://picsum.photos/400/300?random=${destination.id}2`} active={slideIndex === 1} />
                  <Slide src={`https://picsum.photos/400/300?random=${destination.id}3`} active={slideIndex === 2} />
                </ImageSlideshow>
                ...
                <CardContent>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', fontSize: '0.85rem', color: theme.colors.textSecondary, marginBottom: '1rem' }}>
