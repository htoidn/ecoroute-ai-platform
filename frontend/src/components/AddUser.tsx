...
export default function AddUser() {
    const [formData, setFormData] = useState<UserFormData>({
        username: '', email: '', password: '', role: 'USER', preferred_budget: 0, preferred_climate: ''
    });
    ...
    const roleOptions = [{label: 'User', value: 'USER'}, {label: 'Admin', value: 'ADMIN'}];

    const climateOptions = [{label: 'Cool', value: 'cool'}, {label: 'Warm', value: 'warm'}, {
